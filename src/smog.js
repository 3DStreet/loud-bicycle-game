...
AFRAME.registerComponent('smog', {
    ...
    init: function() {
        ...
        this.el.setAttribute('particle-system', 'texture: ./assets/fog-256.png; velocityValue: 0 0.1 0; accelerationValue: 0 0.1 0; accelerationSpread: 0.1 0 0.1; velocitySpread: 0.14 0 0.14; particleCount: 5; maxAge: 3; size: 2,4; opacity: 0,1,0; randomize: true; color: #666,#222')
    },
